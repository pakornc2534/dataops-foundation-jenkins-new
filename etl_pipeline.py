...
def create_star_schema(df):
    ...
    if 'home_ownership' in df.columns:
        ...
        dim_tables['home_ownership_dim_kong'] = home_ownership_dim
    ...
    if 'loan_status' in df.columns:
        ...
        dim_tables['loan_status_dim_kong'] = loan_status_dim
    ...
    if 'issue_d' in df.columns:
        ...
        dim_tables['issue_d_dim_kong'] = issue_d_dim
...
def deploy_to_database(fact_table, dim_tables):
    ...
    try:
        ...
        fact_table.to_sql('loans_fact_kong', con=engine, if_exists='replace', index=False)
